...
var zenkraft = require('int_zenkraft/cartridge/scripts/models/ZenkraftModel');
...
function updateShippingMethodList() {
    ...
    // If Zenkraft is enabled. Get the Shipping Data for the current address, cart, and currently applicable shipping methods
    if (Site.getCurrent().getCustomPreferenceValue('enableZenkraftShipping')) {
    	var zenkraftMethods = zenkraft.GetShippingData(address, cart, applicableShippingMethods);
    }
    ...
    app.getView({
        ...
        ZenkraftMethods: zenkraftMethods
